...
namespace LidyaPos\Slug\Http\Controllers;
...
use LidyaPos\Slug\Http\Requests\SlugRequest;
use LidyaPos\Slug\Repositories\Interfaces\SlugInterface;
use LidyaPos\Slug\Services\SlugService;
